...
console.log("1. Rota first-class /api/web/research é chamada pelo frontend:");
check("fetch('/api/web/research') presente em AviaryApp.tsx", /fetch\('\/api\/web\/research'/.test(appSrc));
...
const searchMsgMatch = appSrc.match(/Pesquisa web real[\s\S]{0,900}/);
