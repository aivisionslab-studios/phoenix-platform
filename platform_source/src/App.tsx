...
export default function App() {
  ...
  // PHX-PHASE6M: workspace_path é estado de instalação, não telemetria.
  // Busca uma vez quando o Engine entra online (e novamente se cair/subir),
  // em vez de gerar um segundo polling de /api/state a cada 5s.
  useEffect(() => {
    ...
    const fetchWorkspacePath = async () => {
      try {
        ...
        // Engine inacessível durante a transição de boot — mantém o valor
        // anterior; a próxima transição offline -> online tentará de novo.
      }
    };
    fetchWorkspacePath();
