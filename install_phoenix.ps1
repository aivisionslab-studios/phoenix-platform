...
# =====================================================================
# PHOENIX RESOURCE POLICY: o instalador não fixa placement por categoria.
# Phoenix Llama Runtime e Phoenix Diffusion decidem em AUTO; CPU/GPU/HYBRID
# permanecem overrides explícitos do usuário. O sanity gate continua obrigatório
# para placements Vulkan sensíveis em Polaris.
# =====================================================================
 $env:PHOENIX_LLM_DEVICE = "AUTO"
 $env:PHOENIX_IMAGE_DEVICE = "AUTO"
 $env:PHOENIX_LLM_NGL = "auto"
 $env:PHOENIX_LLM_GPU_DEVICE = "auto"
...
try {
    ...
    Write-Host "==================================" -ForegroundColor Cyan
    Write-Host " -> Politica de Hardware: Phoenix AUTO (Llama Runtime + Diffusion)" -ForegroundColor Yellow
