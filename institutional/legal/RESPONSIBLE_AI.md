...
## Telemetria de comportamento de modelos

A Phoenix pode registrar e transmitir métricas técnicas sobre comportamento, desempenho, falhas, tempo de execução e compatibilidade de modelos/runtimes para melhorar a plataforma. Esse uso técnico não deve ser confundido com coleta rotineira do conteúdo integral de prompts ou respostas.
