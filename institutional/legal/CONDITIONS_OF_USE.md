...
## 4. Controle do usuário e comunicações técnicas

O usuário mantém controle sobre missões, modelos e recursos que inicia. A Phoenix, porém, pode
realizar comunicações técnicas necessárias ou previstas para recursos conectados, atualização,
diagnóstico, suporte e telemetria da plataforma.

Dados técnicos do scanner/setup, hardware, execução de modelos, desempenho e erros podem ser
transmitidos aos serviços Phoenix/AIVisionsLab conforme as políticas de privacidade e telemetria.

Isso não autoriza a Phoenix a tratar documentos privados ou credenciais como telemetria comum.
